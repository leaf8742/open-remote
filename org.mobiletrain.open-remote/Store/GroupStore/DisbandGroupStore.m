...
- (void)requestWithSuccess:(void (^)())success failure:(void (^)(NSError *))failure {
    ...
    [[EaseMob sharedInstance].chatManager asyncDestroyGroup:[self.group.identity withoutSeparator] completion:^(EMGroup *group, EMGroupLeaveReason reason, EMError *error) {
        emerror = error;
